...
////        Person student1 = new Person("student1@wethinkcode.co.za", firstname, lastname, password);
//        Person student2 = new Person("student2@wethinkcode.co.za", firstname, lastname, password);
//        Person student3 = new Person("student3@wethinkcode.co.za", firstname, lastname, password);
//
...
//        Person p = new Person("student1@wethinkcode.co.za", firstname, lastname, password);
...
//        Person p = new Person("unknownstudent@wethinkcode.co.za", firstname, lastname, password);
//        Collection<Expense> expenses = dao.findExpensesForPerson(p);
...
//        Person p = new Person("newstudent@wethinkcode.co.za", firstname, lastname, password);
...
//        Person p = new Person("student2@wethinkcode.co.za", firstname, lastname, password);
