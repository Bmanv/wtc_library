...
//        Person p1 = new Person("student1@wethinkcode.co.za", firstname, lastname, password);
//        Person p2 = new Person("student2@wethinkcode.co.za", firstname, lastname, password);
//        Person p3 = new Person("student3@wethinkcode.co.za", firstname, lastname, password);
