...
//    private final Person personWhoPaidForSomeone = new Person("ipaidforyou@wethinkcode.co.za", firstname, lastname, password);
//    private final Person personWhoShouldPayBack = new Person("ioweyou@wethinkcode.co.za", firstname, lastname, password);
//
//    @Test
...
//        Person anotherPersonThatShouldPay = new Person("another@wethinkcode.co.za", firstname, lastname, password);
